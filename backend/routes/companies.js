...
router.put('/:id', async (req, res, next) => {
  ...
  try {
    ...
    next({ message: 'Erreur lors de la mise à jour de l\'entreprise.', details: error.message });
  }
});
...
router.delete('/:id', async (req, res, next) => {
  ...
  try {
    ...
    next({ message: 'Erreur lors de la suppression de l\'entreprise.', details: error.message });
  }
});
